...
void loop() {
  ...
  if(mySerial.available())
  {
   ...
   //  Serial.println(0);
    ...
    if(fileIndex==0){play_file("1.mp3");}
    if(fileIndex==6){play_file("2.mp3");}
    if(fileIndex==12){play_file("3.mp3");}
    if(fileIndex==36){play_file("7.mp3");}
    if(fileIndex==30){play_file("yrzf.mp3");}
